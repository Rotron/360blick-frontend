...
$templateCache.put("partials/fileInput.html","<div class=\"input input--{{classSuffix}}\" ng-class=\"{\'is-filled\': value, \'is-focused\': isFocused}\" ng-click=\"setFocus()\">\n    <!--<label class=\"input__label input__label--{{classSuffix}}\">{{label}}</label>-->\n\n    <button class=\"btn btn--cta\" type=\"file\" ng-model=\"value\" ng-file-select accept=\"\'image/*\'\" ng-file-change=\"upload($files, $event)\">Upload</button>\n\n    <!-- <input type=\"file\" class=\"input__field input--{{classSuffix}}__field\" ng-model=\"value\" ng-change=\"onChange()\" ng-blur=\"onBlur()\"> -->\n</div>");
$templateCache.put("partials/minMaxValue.html","<div class=\"minmax-interaction container\">\n    <!-- todo: refactor minmax and xyz to editor-option -->\n    <div class=\"minmax-interaction__title col span-3\">{{title}}</div>\n    <div class=\"minmax-interaction__slider col span-6\">\n        <input type=\"range\" min=\"0\" max=\"1\" step=\"0.01\" ng-model=\"item\">\n    </div>\n    <div class=\"col span-3\">\n        <div class=\"input--sidebar\">\n            <label class=\"input--sidebar__label\">\n                <span class=\"input--sidebar__label__unit\">%</span>\n                <input class=\"input--sidebar__field\" type=\"number\" ng-model=\"item\" min=\"{{min}}\" max=\"{{max}}\" step=\"{{step || 1}}\">\n            </label>\n        </div>\n    </div>\n</div>");
...
$templateCache.put("sceneTemplates/sceneTemplates.html","<div class=\"interaction-bar container\">\n    <div class=\"col span-6\">\n        <button ng-click=\"openModal(\'newSceneTemplate\')\" class=\"btn btn--dotted\"><i class=\"fa fa-plus\"></i>New Template</button>\n    </div>\n    <div class=\"col span-6 has-text-right\">\n        <button class=\"btn btn--dropdown btn--dropdown--light\">Most Recent<i class=\"fa fa-chevron-down\"></i></button>\n        <button class=\"btn\"><i class=\"fa fa-th-list\"></i></button>\n        <button class=\"btn\"><i class=\"fa fa-th\"></i></button>\n    </div>\n</div>\n\n<ul class=\"overview-list container\">\n    <li ng-repeat=\"template in templates track by $index\" ui-sref=\"template({username: username, templateId: template.id})\" class=\"overview-list__item col span-6\">\n        <div class=\"overview-list__asset\" style=\"background-image:url(http://upload.wikimedia.org/wikipedia/commons/6/60/Matterhorn_from_Domh%C3%BCtte_-_2.jpg);\">\n            <div class=\"overview-list__color\" style=\"background-color:rgba(100,100,160, 0.5);\"></div>\n            <div class=\"overview-list__content container\">\n                <div class=\"col span-8\">\n                    <h2 class=\"overview-list__title\">{{template.title}}</h2>\n                    <time class=\"overview-list__modified\" datetime=\"2000-01-30 18:00\">Last modified: {{template.description}}</time>\n                </div>\n                <div class=\"col span-4 has-text-right\">\n                    <button class=\"btn btn--cta\">Edit</button>\n                </div>\n            </div>\n        </div>\n    </li>\n</ul>");
